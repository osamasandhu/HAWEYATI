...
class _ScaffoldingOrderDetailState extends State<ScaffoldingOrderDetail> {
  ...
  Widget build(BuildContext context) {
    return 
      ...
      ScrollablePage(child: SliverList(delegate: SliverChildListDelegate(
          [
...
/////////////////////////////,
          ...
          ])),subtitle: loremIpsum.substring(0,190),title: "Order",action: tr("Continue"),showButtonBackground: true,onAction:
          () {
