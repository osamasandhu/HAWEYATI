...
class BuildingMaterailListPage extends ServiceListPage<BuildingMaterials, BuildingMaterialService> {
  BuildingMaterailListPage(): super(
      name: 'Building Material',
      service: BuildingMaterialService(),
      builder: (List<BuildingMaterials> building) {
        return SliverList(
            delegate: SliverChildBuilderDelegate(
                  ...
                  return ServiceListItem(
                      ...
                      image: building[i].images[0].name,
                      //name: dumpsters[i].size,
                      //image: dumpsters[i].image.name,

                      onTap: () {
                        CustomNavigator.navigateTo(context, BuildingMaterialSubListPage(id: building[i].sId));
                      }
                  );
                },
