...
class _BuildingOrderDetailState extends State<BuildingOrderDetail> {
  ...
  Widget build(BuildContext context) {
    return 
      ...
      ScrollablePage(title: "Order",subtitle: loremIpsum.substring(0,86),action: tr("Continue"), showButtonBackground: true,
...
/////////////////////////////,
        ...
        Row(children: <Widget>[
          ...
          Text("515.00 SR",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),) ],
          mainAxisAlignment: MainAxisAlignment.spaceBetween,)]),) ,onAction: () {
