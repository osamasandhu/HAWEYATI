...
class _OrderGenerateState extends State<OrderGenerate> {
  ...
  Widget build(BuildContext context) {
    return 
      ...
      ScrollablePage(title: "Services Detail",subtitle: loremIpsum.substring(0,35),child: SliverList(delegate: SliverChildListDelegate([
...
//
      ...
      } ,action: tr("Continue"),showButtonBackground: true,);
      Scaffold(
