...
//  File _image;
  ...
  Widget build(BuildContext context) {
    ...
    return 
      ScrollablePage(key: scaffoldKey,title: "Location & Time",subtitle: loremIpsum.substring(0,65),child: SliverList(delegate: SliverChildListDelegate([
